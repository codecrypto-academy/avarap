...
$deployOutput = docker-compose run --rm -e PRIVATE_KEY=$env:PRIVATE_KEY foundry forge script script/Deploy.s.sol --rpc-url http://anvil:8545 --broadcast -vvv 2>&1 | Out-String
